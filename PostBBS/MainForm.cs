...
namespace PostBBS
{
    ...
    {
        //string postbbsapi = @"http://localhost:27154/bbs/PostBBS?title={0}&content={1}";
        //string postimgapi = @"http://localhost:27154/bbs/PostImage";
        //string bbsisexistapi = @"http://localhost:27154/bbs/BBSIsExist?title=";
        ...
        public MainForm()
        {
            ...
            //string connStr = System.Configuration.ConfigurationManager.ConnectionStrings["etoland.Properties.Settings.ConnectionString"].ConnectionString;
